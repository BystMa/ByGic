...
var Game = new (function() {
  ...
  function startGame(puzzle) {
    ...
    $('#boardsize').html('<span>' + puzzle.size + '<span style= \"font-family: \'roboto\'\">x</span>' + puzzle.size + '</span>');
  ...
  function updateTweetUrl(size) {
    var msg = '#bayneri I just completed a ' + size + ' x ' + size + ' puzzle and my score is ' + getScore() + '. http://brinng.com/bayneri ',
